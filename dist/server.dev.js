...
var controlAsy = require("./Controller/asyncControllers.js");

var controlOth = require("./Controller/otherControllers.js");

var asyncClass = new controlAsy.asyncClass();
var otherClass = new controlOth.otherControllersClass(); //  USE's

app.use(express["static"]("public"));
app.use(bodyParser.urlencoded({
  extended: false
}));
app.use(bodyParser.json()); // SET's 

app.set("views", "View");
app.set("view engine", "ejs"); // GET's
